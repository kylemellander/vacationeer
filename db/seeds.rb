...
city = City.create({:city_name => 'Las Vegas, NV', :country_name => 'United States', img: "/img/las_vegas.jpg"})
Airport.create({:airport_code => "LAS", :city_id => city.id})

city = City.create({:city_name => 'Berlin', :country_name => 'Germany', img: "/img/berlin.jpg"})
Airport.create({:airport_code => "TXL", :city_id => city.id})

city = City.create({:city_name => 'Paris', :country_name => 'France', img: "/img/paris.jpg"})
Airport.create({:airport_code => "ORY", :city_id => city.id})

city = City.create({:city_name => 'Madrid', :country_name => 'Spain', img: "/img/madrid.jpg"})
Airport.create({:airport_code => "MAD", :city_id => city.id})

city = City.create({:city_name => 'Philadelphia, PA', :country_name => 'United States', img: "/img/philadelphia.jpg"})
Airport.create({:airport_code => "PHL", :city_id => city.id})

city = City.create({:city_name => 'New York, NY', :country_name => 'United States', img: "/img/new_york.jpg"})
Airport.create({:airport_code => "JFK", :city_id => city.id})

city = City.create({:city_name => 'Victoria', :country_name => 'Canada', img: "/img/victoria.jpg"})
Airport.create({:airport_code => "YYJ", :city_id => city.id})

city = City.create({:city_name => 'Houston, TX', :country_name => 'United States', img: "/img/houston.jpeg"})
Airport.create({:airport_code => "JFK", :city_id => city.id})

city = City.create({:city_name => 'San Francisco, CA', :country_name => 'United States', img: "/img/san_francisco.jpg"})
Airport.create({:airport_code => "SFO", :city_id => city.id})

city = City.create({:city_name => 'Miami, FL', :country_name => 'United States', img: "/img/miami.jpg"})
Airport.create({:airport_code => "MIA", :city_id => city.id})

city = City.create({:city_name => 'Kingston', :country_name => 'Jamaica', img: "/img/jamaica.jpg"})
